...
for (i_tref in c(1994, 2004, 2014)) {
  ...
  for (i_year in i_tref + seq(-2, 2, 1)) {
...
```{r write_acidification_output_files}
...
```{r write_buffer_output_files}

buffer_trend %>% 
  write_csv(paste0(path_OIA, "buffer_all.csv"))
