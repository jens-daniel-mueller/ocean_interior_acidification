...
pdf(
  here::here("output/saturation_volumes.pdf"),
  width = 10,
  height = 8
)
...
ggsave(  here::here("output/profiles_MOBO-DIC_vs_eMLR_no_fill.jpg"),
  width = 5,
  height = 5,
  dpi = 600)
...
ggsave(  here::here("output/profiles_MOBO-DIC_vs_eMLR.jpg"),
  width = 5,
  height = 5,
  dpi = 600)
