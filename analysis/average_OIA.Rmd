...
path_out <-   paste0(path_observations, "output_main/")
...
ggsave(
  here::here("output/main/omega_bottom.png"),
  width = 10,
  height = 5,
  dpi = 600,
  bg = "white"
...
ggsave(
  here::here(
    paste0(
      "output/main/profiles_total_changes_basin.png"
    )
  ),
  width = 10,
  height = 10,
...
ggsave(
  here::here(
    paste0("output/main/profiles_total_changes_basin_relative.png")
  ),
  width = 10,
  height = 10,
  dpi = 600,
...
ggsave(
  here::here(
    "output/main/acidification_rates_500m_relative.png"
  ),
  width = 8,
  height = 6,
  dpi = 600,
