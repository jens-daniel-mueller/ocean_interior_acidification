...
acidification_profiles_station_obs_reconstructed %>%
  ...
  #   linewidth = 0.3
  # ) +
  scale_fill_manual(values = c("#beaed4", "#7fc97f", "#386cb0"),
                    labels = labels_tco2) +
  scale_color_manual(values = c("#beaed4", "#7fc97f", "#386cb0"),
                     labels = labels_tco2) +
...
ggsave(
  here::here(
    paste0(
      "output/main/BATS_ALOHA_20_yr_changes.png"
    )
  ),
  width = 6,
  height = 4,
...
acidification_profiles_station_obs_reconstructed %>%
  ...
  geom_path(
        data = . %>% filter(variable %in% c("H_free", "OmegaAragonite", "tco2")),
        aes(col = DIC_variant, linetype = driver, linewidth = DIC_variant)) +
  scale_discrete_manual("linewidth",
                        labels = labels_tco2,
                        values = c(0.3, 0.3, 1))+
