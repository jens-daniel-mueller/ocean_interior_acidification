...
scales::show_col(three_year_colors)
three_year_colors_2014 <- c(rep("transparent",2),three_year_colors[3])

two_year_colors <- three_year_colors[-3]
scales::show_col(two_year_colors)

four_year_colors <- c("grey50", three_year_colors)
scales::show_col(four_year_colors)
...
acidification_depth_layer_total_zonal <-
  ...
  summarise(delta_total_sd = sd(delta_total, na.rm = TRUE),
...
acidification_depth_layer_total_zonal %>% 
  ...
  scale_fill_manual(values = three_year_colors_2014) +
